...
public class Test1 
{
	public static void main(String[] args) throws Exception
	{
		...
		//Create Recording object with Path,video file and audio(false/true)
		ATUTestRecorder rec=new ATUTestRecorder(fo.getAbsolutePath(),"videoon "+fname,true); //false is for NO Audio
		rec.start();
